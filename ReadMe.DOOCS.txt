...
MTCA4U comes with a Makefile include file, called MTCA4U.CONFIG, which is located in the installation directory (for instance ${HOME}/mtca4u/${DOOCSARCH}/[MTCA4U_VERSION]).
